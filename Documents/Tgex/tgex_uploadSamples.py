...
# ---------------------------------
parser = argparse.ArgumentParser(prog='tgex_uploadSamples.py', description='Uploads a set of vcf file as a sample to TGex')
# the files
...
parser.add_argument('--sampleTarget', help = 'Sample target', choices=['WholeGenome','Exome','GenePanel','TargetRegion'], default='Exome')
...
parser.add_argument('--config','-c', help = 'configuration file', default='tgex.config.yml')
